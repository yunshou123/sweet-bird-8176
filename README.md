...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/ai
```

A live public deployment of this template is available at [https://ai.templates.workers.dev](https://ai.templates.workers.dev)
